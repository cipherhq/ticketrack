#!/usr/bin/env python3
"""
Ticketrack International Bank Account Installation Script
Adds support for US/UK/CA bank accounts alongside existing NG/GH Paystack flow
"""
...
files_to_create = {
    "src/pages/organizer/AddBankAccount.jsx": '''import { useState, useEffect } from 'react';
...
def main():
    print("=" * 60)
    print("Ticketrack International Bank Account Installation")
    print("=" * 60)
    ...
    print("2. Test the form with different country organizers")
    print("=" * 60)
