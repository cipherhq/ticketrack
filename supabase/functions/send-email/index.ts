...
const templates: Record<EmailType, (data: Record<string, any>) => { subject: string; html: string }> = {
  ...
  ticket_purchase: (data) => ({
    ...
    html: baseTemplate(`
      <div class="success"><strong>✅ Booking Confirmed!</strong></div>
      <h2>You're going to ${data.eventTitle}!</h2>
      ...
      <div class="highlight"><strong>📱 Pro Tip:</strong> Save or screenshot your ticket before the event!</div>
    `, 'Your tickets for ' + data.eventTitle + ' are confirmed!')
  }),
