        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 sm:py-28">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-12 text-gray-900 max-w-lg mx-auto shadow-2xl">
              <div className="text-center">
                <p className="text-gray-600 mb-4">Service fee per paid ticket</p>
                <div className="flex items-baseline justify-center gap-2 mb-2">
                  <span className="text-5xl sm:text-6xl font-bold text-[#2969FF]">{pricing.percentage}</span>
                  {pricing.flatFeeValue > 0 && (
                    <>
                      <span className="text-3xl sm:text-4xl font-bold text-gray-600">+</span>
                      <span className="text-5xl sm:text-6xl font-bold text-[#2969FF]">{pricing.currency}{pricing.flatFee}</span>
                    </>
                  )}
                </div>
                <p className="text-gray-600 mb-2">per ticket sold</p>
                {pricing.cap && (
                  <p className="text-sm text-gray-600 mb-6">Capped at {pricing.currency}{pricing.cap} per order</p>
                )}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featureCards.map((card, index) => (
              <div 
                key={index}
                className="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-[#2969FF]/20 hover:shadow-xl transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden max-w-4xl mx-auto">
            ...
            {featureComparison.map((row, index) => (
              ...
              >
                <div className="p-4 sm:p-6 text-gray-900/80 flex items-center">
                  {row.feature}
                </div>
              ...
              <div 
                ...
                className={`rounded-2xl p-6 border-2 transition-all hover:shadow-lg ${
                  selectedCountry === code 
                    ...
                    : 'border-gray-200 bg-white hover:border-gray-200/20'
                }`}
              >
                ...
                <p className="text-sm text-gray-600 mb-4">per paid ticket</p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="flex items-start gap-4 bg-white rounded-xl p-5 border border-gray-200">
