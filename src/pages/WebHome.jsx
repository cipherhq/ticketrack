    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-blue-600 text-white py-10">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-3">Ready to Host Something Amazing?</h2>
          <p className="text-blue-100 mb-6">
            Create ticketed events or free party invites — all in one place
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 bg-card text-blue-600 font-semibold px-8 py-4 rounded-xl hover:bg-blue-50 transition-colors cursor-pointer"
            >
              Create Event
            </button>
            <button
              ...
              className="inline-flex items-center justify-center gap-2 border-2 border-white text-white font-semibold px-8 py-4 rounded-xl hover:bg-white/10 transition-colors cursor-pointer"
            >
