  ...
  return (
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-bold text-[#0F0F0F] mb-8">Browse by Category</h2>
          ...
          {categories.map((category) => (
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-medium text-[#0F0F0F] mb-1">{category.name}</h3>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold text-[#0F0F0F]">Featured Events</h2>
          <Button
            variant="ghost"
            onClick={() => navigate('/events')}
          ...
          {featuredEvents.map((event) => (
            ...
            >
              ...
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold text-[#0F0F0F] mb-3">{event.name}</h3>
      ...
      <section className="bg-[#F4F6FA] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-[#0F0F0F] mb-2">Events Near You</h2>
            ...
            {eventsNearYou.map((event) => (
              ...
              >
                ...
                <CardContent className="p-4">
                  <h3 className="font-semibold text-[#0F0F0F] mb-2 line-clamp-1">{event.name}</h3>
                  ...
                  <div className="text-[#2969FF] text-sm font-medium">{event.price}</div>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#0F0F0F] mb-4">Why Choose Ticketrack?</h2>
