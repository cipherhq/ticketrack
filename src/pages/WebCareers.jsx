    ...
    <div className="min-h-screen bg-muted">
      ...
      <div className="bg-gradient-to-br from-[#2969FF] to-[#1e4fd6] text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a href="#positions" className="inline-flex items-center gap-2 bg-card text-[#2969FF] px-8 py-4 rounded-xl font-semibold hover:bg-card/90 transition-colors">
            View Open Positions
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Benefits */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-foreground mb-6 text-center">Benefits & Perks</h2>
          <div className="grid md:grid-cols-3 gap-4">
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-card rounded-2xl border border-border/10 p-6 text-center">
          ...
          {openPositions.length > 0 ? (
            <div className="space-y-4">
              {openPositions.map((position, index) => (
                <div key={index} className="bg-card rounded-2xl border border-border/10 p-6 hover:border-[#2969FF]/30 transition-colors cursor-pointer">
            ...
            <div className="bg-card rounded-2xl border border-border/10 p-12 text-center">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">No Open Positions Right Now</h3>
        ...
        <section>
          <div className="bg-gradient-to-br from-[#0F0F0F] to-[#2a2a2a] rounded-2xl p-8 text-center text-white">
            ...
            <a href="mailto:careers@ticketrack.com" className="inline-flex items-center gap-2 bg-card text-foreground px-6 py-3 rounded-xl font-semibold hover:bg-card/90 transition-colors">
              <Mail className="w-5 h-5" />
