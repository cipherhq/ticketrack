  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-semibold text-foreground">Platform Orders</h2>
          <p className="text-muted-foreground mt-1">View and manage all orders across the platform</p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {Object.keys(stats.revenueByCurrency || {}).length > 0 ? (
                  ...
                  <h3 className="text-2xl font-semibold text-muted-foreground">—</h3>
                )}
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-2xl font-semibold text-foreground">{stats.refundedOrders}</h3>
              </div>
            </div>
          </CardContent>
        </Card>
                  ...
                  {expandedOrder === order.id && (
                    <div className="border-t border-border/10 bg-muted/30 p-4">
                      <div className="grid md:grid-cols-3 gap-6">
                        ...
                        {/* Financial Details */}
                        <div>
                          <h4 className="font-medium text-foreground mb-3">Financial Details</h4>
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                        ...
                        <div>
                          ...
                          <div className="space-y-2 max-h-40 overflow-y-auto">
                            {order.tickets.map((ticket) => (
                              <div key={ticket.id} className="p-2 bg-card rounded-lg border border-border/10">
                                <div className="flex justify-between items-start">
                                  <div>
                                    <p className="font-medium text-foreground text-sm">{ticket.attendee_name}</p>
                                    <p className="text-xs text-muted-foreground">{ticket.ticket_types?.name || 'Standard'}</p>
                                  </div>
