...
import { Search, Mail, Download, Filter, MoreVertical, Loader2, Users, CheckCircle, Clock, Calendar, RefreshCw } from 'lucide-react';
...
export function ManageAttendees() {
  ...
  const exportToCSV = () => {
    const headers = ['Name', 'Email', 'Phone', 'Event', 'Ticket Type', 'Ticket ID', 'Purchase Date', 'Status', 'Check-in Time'];
