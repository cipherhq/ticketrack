  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[#0F0F0F]">Support</h1>
          <p className="text-[#0F0F0F]/60">Get help from our support team</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="rounded-2xl border-[#0F0F0F]/10">
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-[#0F0F0F]">{tickets.length}</p>
      ...
      {tickets.length === 0 ? (
        <Card className="rounded-2xl border-[#0F0F0F]/10">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-[#0F0F0F]/60 mb-6">Need help? Create a support ticket and we'll assist you.</p>
            <Button onClick={() => setView('create')} className="bg-[#2969FF] hover:bg-[#1a4fd8] rounded-xl">
