    ...
    <div className="min-h-screen bg-muted">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-foreground mb-6">How We Protect You</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-card rounded-2xl border border-border/10 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-foreground">For Attendees</h3>
              </div>
            ...
            <div className="bg-card rounded-2xl border border-border/10 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-foreground">For Organizers</h3>
              </div>
              <ul className="space-y-3">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-[#2969FF]/10 to-[#2969FF]/5 rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-foreground mb-4">Report a Problem</h2>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="/contact" className="inline-flex items-center gap-2 bg-card text-foreground px-6 py-3 rounded-xl border border-border/10 hover:bg-muted transition-colors">
