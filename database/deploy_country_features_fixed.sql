-- Country Features Deployment for Supabase SQL Editor
...
BEGIN
    ...
    IF country_count = 0 THEN
        RAISE NOTICE 'No active countries found. Please ensure your countries table has active countries.';
        RAISE NOTICE 'You can add countries like: INSERT INTO countries (code, name, is_active) VALUES (''NG'', ''Nigeria'', true);';
        RETURN;
    END IF;
    
    IF feature_count = 0 THEN
        RAISE NOTICE 'Inserting default features for % countries...', country_count;
