-- Simple Country Features Setup - Fallback Version
...
-- Create feature categories first
...
-- Create main country features table
...
-- Insert features for Nigeria (NG)
...
-- Insert features for United Kingdom (GB)
INSERT INTO country_features (country_code, feature_name, is_enabled, description, category) VALUES
...
-- Insert features for United States (US)
INSERT INTO country_features (country_code, feature_name, is_enabled, description, category) VALUES
...
-- Verification
SELECT 'Simple setup completed!' as status;
